...
export const sidebarInboxTab_DOM = document.querySelector(`[data-sidebar-inbox-button]`);
export const sidebarTodayTab_DOM = document.querySelector(`[data-sidebar-today-button]`);
export const sidebarWeekTab_DOM = document.querySelector(`[data-sidebar-week-button]`);
export const sidebarMonthTab_DOM = document.querySelector(`[data-sidebar-month-button]`);
